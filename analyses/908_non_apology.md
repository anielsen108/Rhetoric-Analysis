# Passage 908: The Non-Apology

**A Corporate Press Office** · *Statement Regarding Recent Events* (a composed specimen) · 2025 | Full text

**Occasion/Pressure:** Something has gone publicly wrong, and a statement must appear to accept responsibility while accepting none.
**Persona/Stance:** The first-person plural of no one; contrition's grammar with contrition extracted.
**Thesis of Effect:** The agentless passive as getaway car, apophasis that mentions what it refuses to discuss, euphemism laid over every noun that could hurt, and a conditional that converts the injured into hypotheses. This is rhetoric's dark mirror — every device competent, every purpose corrupt.

---

## PASSAGE

[L1] Mistakes were made, and lessons have been learned.
[L2] We will not dwell on who may or may not have authorized the events in
[L3] question, nor mention the regrettable miscommunications that occurred.
[L4] If anyone was offended by what transpired, we regret that they feel that
[L5] way.
...
### **Euphemism** (a coat of paint per noun)
**Lines:** L2–4
