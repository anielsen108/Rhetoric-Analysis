# Passage 901: A Dark and Stormy Night

**Edward Bulwer-Lytton** · *Paul Clifford* · 1830 | Opening sentence

**Occasion/Pressure:** A novel's threshold, squandered. The most infamous opening in English fiction, and the patron sentence of purple prose.
**Persona/Stance:** A narrator determined to be atmospheric and unwilling to stop qualifying long enough to manage it.
**Thesis of Effect:** Every image is issued and immediately recalled. The sentence hedges, digresses, and decorates until the storm it announces has nothing left to do.

---

## PASSAGE

[L1] It was a dark and stormy night; the rain fell in torrents—except at occasional
[L2] intervals, when it was checked by a violent gust of wind which swept up the
[L3] streets (for it is in London that our scene lies), rattling along the housetops,
[L4] and fiercely agitating the scanty flame of the lamps that struggled against the
[L5] darkness.
