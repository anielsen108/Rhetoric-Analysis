# Passage 907: The Bistro Menu

**A Neighbourhood Bistro** · *Autumn Menu* (a composed specimen) · 2025 | Starters page

**Occasion/Pressure:** The fries must justify fourteen dollars. The menu writer has elected to do this with superlatives rather than potatoes.
**Persona/Stance:** Breathless retail maximalism; every dish a destiny.
**Thesis of Effect:** Hyperbole applied uniformly until it cancels itself, "literally" deployed to mean its own opposite, and epithets stacked where evidence should be. Inflation economics, performed in prose: when everything is legendary, the currency is worthless.

---

## PASSAGE

[L1] Prepare for a life-changing explosion of hand-crafted, artisanal flavour that
[L2] will transport your taste buds on an unforgettable odyssey.
[L3] Our legendary signature fries are quite literally the best thing you will ever
[L4] eat in your entire life.

---

## A) RHETORICAL TROPES USED

### **Hyperbole** (at fixed maximum)
**Lines:** L1, L3–4
...
### **Epithet** (stacked, in lieu of evidence)
**Lines:** L1, L3
...
### **Semantic Inversion of "Literally"**
**Lines:** L3
**Definition:** The word securing a claim to fact, used to decorate a claim of fancy.
**Evidence:** "quite literally the best thing you will ever eat"
**Effect:** "Literally" exists to mark the border between figure and fact; used here, it asserts a verifiable falsehood with the confidence of a measurement. The solecism is doubly expensive — the word is wasted *and* the reader is reminded, at the sentence's climax, that this menu will say anything.
