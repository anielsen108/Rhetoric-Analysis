# Passage 088: Birth of a Nation (*Midnight's Children*)

**Salman Rushdie** · *Midnight's Children* · 1981 | Opening paragraphs

**Occasion/Pressure:** Narrator aligns his birth with India’s independence, rejecting timeless fairy-tale openings for historical specificity.
**Persona/Stance:** Saleem Sinai speaking directly to reader; playful yet precise.
**Thesis of Effect:** Self-correction, precise prepositional stacks, and rhetorical questions tie personal origin to national chronology.

---

## PASSAGE

[L1] I was born in the city of Bombay...once upon a time.
[L2] No, that won't do, there's no getting away from the date: I was born in Doctor Narlikar's Nursing Home on August 15th, 1947.
[L3] And the time? The time matters, too.
...
### **Aposiopesis**
**Evidence:** Ellipsis in L1 and sudden rejection in L2.
**Effect:** Interrupts fairy-tale cadence; announces history will intrude.

### **Correctio**
**Evidence:** "No, that won't do…"
**Effect:** Narrator revises himself, foregrounding reliability concerns.

### **Allusion**
**Evidence:** "once upon a time" invokes fairy tale convention.
**Effect:** Highlights contrast between myth and modern politics.

### **Anaphora/Epistrophe blend**
**Evidence:** "The time? The time matters." 
**Effect:** Emphasizes temporal precision through repetition.
...
### **Passive voice**
**Evidence:** "I was born" twice.
**Effect:** Birth happens to him; sets stage for destiny theme.

### **Prepositional stacking**
**Evidence:** "in Doctor Narlikar's Nursing Home on August 15th, 1947."
**Effect:** Piles location/time to anchor history.

### **Colon for revelation**
**Evidence:** "date: I was born..."
**Effect:** Signals pivot from vague to exact.

### **Rhetorical question**
**Evidence:** "And the time?"
**Effect:** Anticipates reader’s demand for completeness.
...
**Signals:** Narrator critiques his own sentence.
**Effect:** Establishes reflexive narrative style.

### **Temporal specificity**
**Signals:** Exact date/time references.
**Effect:** Aligns personal life with midnight of Indian independence.

### **Oral cadence**
**Signals:** Conversational asides ("No, that won't do").
**Effect:** Creates intimacy, improvisational feel.
...
**Aposiopesis** — Breaking off abruptly.
**Correctio** — Rhetorical self-correction.
**Passive voice** — Subject receives action ("I was born").
**Rhetorical question** — Asked for effect, not answer.
**Prepositional phrase** — Modifier beginning with preposition ("in Doctor Narlikar’s…").
